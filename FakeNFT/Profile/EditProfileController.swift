...
final class EditProfileController: UIViewController, UITextFieldDelegate, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        nameField.backgroundColor = UIColor(named: "Light grey")
        ...
        descriptionField.backgroundColor = UIColor(named: "Light grey")
        ...
        emailField.backgroundColor = UIColor(named: "Light grey")
...
extension EditProfileController: EditProfileViewProtocol {
    ...
    func closeWithResult(name: String, description: String, email: String) {
        delegate?.didUpdateProfile(name: name, description: description, email: email)
